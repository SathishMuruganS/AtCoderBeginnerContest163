...
1,2,...,N, print the number of immediate subordinates it has, in its own line.
...
The member numbered 
1 has two immediate subordinates: the members numbered 2 and 3.
